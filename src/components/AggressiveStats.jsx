    ...
    <section className="bg-gray-900 py-20 px-4">
      <div className="container mx-auto text-center">
        <h2 className="text-5xl md:text-6xl font-black text-white mb-8 uppercase tracking-tight">
          ...
          <span className="text-green-500 block mt-2">WE WALK THE F*CKING WALK</span>
        </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto mb-16">
          <div className="text-center">
            ...
            <div className="text-5xl font-black text-green-500 mb-2">200+</div>
          ...
          <div className="text-center">
            ...
            <div className="text-5xl font-black text-green-500 mb-2">$50M+</div>
          ...
          <div className="text-center">
            ...
            <div className="text-5xl font-black text-green-500 mb-2">340%</div>
        ...
        <p className="text-xl text-gray-300 mt-12">
          ...
          <span className="text-green-500 font-bold">Now we're giving it to you.</span>
        </p>
      </div>
    </section>
  )
